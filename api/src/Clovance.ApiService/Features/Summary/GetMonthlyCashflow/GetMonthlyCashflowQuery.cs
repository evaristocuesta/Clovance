...
public sealed record GetMonthlyCashflowQuery(Guid? AccountId, string Currency, int MonthsBack = 12, int? AnchorYear = null, int? AnchorMonth = null, AccountTypeFilter? AccountType = null);
