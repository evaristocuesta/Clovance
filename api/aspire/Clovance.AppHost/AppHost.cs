...
// Use different ports to avoid conflicts when both containers might run
var postgres = builder.AddPostgres(postgresResourceName, password: postgresPassword, port: isTestEnvironment ? 5433 : null)
