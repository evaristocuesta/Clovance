...
- Naming conventions: `name.component.ts`, `name.service.ts`
...
- Prefer Reactive forms + signals instead of Template-driven ones
...
## Styles
- CSS with Tailwind and Flowbite components
